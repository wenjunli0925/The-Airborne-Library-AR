...
public class DeformControlText : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            float t = Mathf.InverseLerp(2.3f, 5.1f, distance);
            magnitudeScale = Mathf.Lerp(0f, 2.5f, t);
        }

        if (distance > 5.1)
        {
            float t = Mathf.InverseLerp(5f, 10f, distance);
            magnitudeScale = Mathf.Lerp(2.5f, 0f, t);
        }
